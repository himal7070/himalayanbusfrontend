        ...
        <div className="profile-card p-4">
          <div className="profile-image d-flex flex-column justify-content-center align-items-center">
            ...
            {userDetails.firstName && userDetails.lastName ? (
                <span className="profile-name mt-3">{`${userDetails.firstName} ${userDetails.lastName}`}</span>
            ) : (
            ...
            <div className="d-flex mt-2">
              <Link to="/profile-settings" className="profile-edit-button btn-dark">Edit Profile</Link>
            </div>
